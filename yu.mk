...
PRODUCT_BUILD_PROP_OVERRIDES += \
	BUILD_FINGERPRINT=YU/YUNIQUE/YUNIQUE:$(PLATFORM_VERSION)/$(BUILD_ID)/MMXMR1:$(TARGET_BUILD_VARIANT)/release-keys \
	PRIVATE_BUILD_DESC="YUNIQUE-user $(PLATFORM_VERSION) $(BUILD_ID) MMXMR1 release-keys"
